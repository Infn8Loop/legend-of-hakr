            ...
            <div class="col-xs-12">
                ...
                <div class="options">
                    <h2 class="text-center">
                        <a href="<?php if ($this->session->event['opponent'] >= 1){echo site_url('pvp/hack');} else {echo site_url('events/hack');} ?>">[<span class="fuschia">HACK</span>]</a>  <a href="<?php echo site_url('pvp/abort');?>">[<span class="fuschia">ABORT</span>]</a>
                    </h2>
                </div>
            </div>
        </div>
