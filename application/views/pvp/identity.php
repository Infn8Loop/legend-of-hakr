<?php $this->load->view("includes/header");  $players = $this->data['players'];  ?>
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <h4>The cost to attempt identity theft is 10 E-coins. If you succeed you will take 25% of the players XP.</h4>
                </div>
            </div>
        <div class="row">
    ...
    <?php foreach($players as $player){ ?>
            ...
            <a href="<?php echo site_url('identity/create/' . $player['user_id'])?>">[<span class="fuschia">HACK</span>]</a>
            </h3>
